...
arch_packages = "firefox telegram-desktop discord freeoffice microsoft-office-web-jak vlc qbittorrent nautilus python-nautilus grub-customizer gucharmap tilix zsh rofi feh timeset blueman pulseaudio-bluetooth pa-applet pavucontrol neofetch speedtest-cli wmctrl xclip redshift noto-fonts-emoji"
aur_packages = "google-chrome-stable spotify spicetify-cli spotify-tui spotifyd  mailspring teams nautilus-empty-file visual-studio-code-bin clion pycharm-professional intellij-idea-ultimate-edition webstorm datagrip i3-battery-popup-git"
