...
aur_packages = "google-chrome-stable foxitreader  spotify spicetify-cli spotify-tui spotifyd  mailspring teams nautilus-empty-file visual-studio-code-bin clion pycharm-professional intellij-idea-ultimate-edition intellij-idea-ultimate-edition-jre webstorm datagrip i3-battery-popup-git"
