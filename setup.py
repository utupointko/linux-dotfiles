...
arch_packages = "firefox telegram-desktop discord freeoffice microsoft-office-web-jak vlc qbittorrent nautilus python-nautilus grub-customizer gucharmap tilix zsh rofi timeset blueman pulseaudio-bluetooth pa-applet pavucontrol neofetch speedtest-cli wmctrl xclip redshift noto-fonts-emoji"
